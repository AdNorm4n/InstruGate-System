...
from .views import (
    ...
    QuotationCreateView, SubmittedQuotationView, QuotationReviewView, QuotationSubmitView, QuotationDownloadView,
...
urlpatterns = [
    ...
    path('quotations/<int:pk>/download-pdf/', QuotationDownloadView.as_view(), name='quotation-download-pdf'),
