...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    def _save_file_message(self, room_name, user, sender_type, content, file_name, assistance=None):
        ...
        # File is already saved by the upload endpoint; no need to set msg.file
        logger.debug(f"Saved file message: room={room_name}, file_name={file_name}, file_url={msg.file.url if msg.file else None}")
        return msg
